...
export type UserFragmentFragment = { __typename?: 'User', id: string, name: string, age?: number | null, address?: { __typename?: 'Address', zip: number, street: string, city?: string | null } | null } & { ' $fragmentName'?: 'UserFragmentFragment' };
